#
#  2023/02/27 - cp - Added the additional check to see whether bos.cluster.rte
#		is installed at all.
#
#-------------------------------------------------------------------------------
#
...
#    7.2.5.2    IJ44115m2a.221102.epkg.Z  key_w_fix  CAA  <<-- elsewhere
#    7.2.5.3    IJ41975m3a.221027.epkg.Z  key_w_fix  CAA  <<-- N/A @ Magellan
#    7.2.5.3    IJ41975m3b.221212.epkg.Z  key_w_fix  CAA  <<-- covered here
#    7.2.5.4    IJ41975s4a.221017.epkg.Z  key_w_fix  CAA  <<-- covered here
#    7.3.0.1    IJ42938m1a.221027.epkg.Z  key_w_fix  CAA  <<-- N/A @ Magellan
#    7.3.0.2    IJ42938s2a.221018.epkg.Z  key_w_fix  CAA  <<-- N/A @ Magellan
#
...
#    3.1.3.10    IJ41975m3b.221212.epkg.Z  key_w_fix  CAA  <<-- N/A @ Magellan
#    3.1.3.14    IJ41975m3a.221027.epkg.Z  key_w_fix  CAA  <<-- covered here
#    3.1.3.21    IJ41975s4a.221017.epkg.Z  key_w_fix  CAA  <<-- N/A @ Magellan
#
#-------------------------------------------------------------------------------
#
class aix_ifix_ij41975 {
    ...
    if ($::facts['osfamily'] == 'AIX') {
        ...
        unless ($::facts['aix_vios']['is_vios']) {
            ...
            #  2023/02/27 - cp - This only applies if bos.cluster.rte is installed at all
        ...
        if (($ifixSuffix != 'unknown') and ($ifixBuildDate != 'unknown')) {
            ...
            unless ($ifixFullName in $::facts['aix_ifix']['hash'].keys) {
                ...
                $ifixStagingSource = "puppet:///modules/aix_ifix_ij41975/${ifixName}${ifixSuffix}.${ifixBuildDate}.epkg.Z"
